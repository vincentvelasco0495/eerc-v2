...
export function InstructorQuizStudentsView() {
  ...
  const { quiz, counts, students, meta, isLoading } = useLmsQuizStudentsPaginated(
    quizId,
    page,
    perPage,
    status,
                  ...
                  <Table size="medium">
                    <TableHead>
                      <TableRow sx={styles.headRow}>
                        ...
                        <TableCell sx={{ minWidth: 140 }}>Attempted</TableCell>
