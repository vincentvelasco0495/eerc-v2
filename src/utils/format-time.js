 ...
 */
export function fDateTime(input, template = FORMAT_PATTERNS.dateTime) {
  if (!input) return '';
 ...
 */
export function fDate(input, template = FORMAT_PATTERNS.date) {
  if (!input) return '';
 ...
 */
export function fTime(input, template = FORMAT_PATTERNS.time) {
  if (!input) return '';
 ...
 */
export function fTimestamp(input) {
  if (!input) return '';
 ...
 */
export function fIsBetween(input, start, end) {
 ...
 */
export function fIsAfter(start, end) {
 ...
 */
export function fIsSame(start, end, unit = 'year') {
  if (!start || !end) return false;
 ...
 */
export function fDateRangeShortLabel(start, end, initial) {
  if (!start || !end) return '';
